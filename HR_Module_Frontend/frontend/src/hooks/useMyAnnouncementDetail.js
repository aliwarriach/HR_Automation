...
import { getMyAnnouncement } from "../services/employeeAnnouncementsService";

export function useMyAnnouncementDetail(id) {
  ...
  useEffect(() => {
    ...
    async function fetchDetail() {
      ...
      const response = await getMyAnnouncement(id);
      if (cancelled) return;
