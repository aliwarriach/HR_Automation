...
class ResumeDetailInfo(BaseModel):
    """Candidate summary fields shown on a Resume Detail page."""
    ...
    @classmethod
    def _normalize_cgpa(cls, value: Any) -> Any:
        return (value if value is not None else "") or "N/A"
